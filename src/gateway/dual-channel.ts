 ...
 * An explicit OpenAI route bypasses Messages. Each prepared call retains its
 * primary adapter; the compatibility delegate owns its route resolution.
 * Cancellation never triggers failover.
 */
